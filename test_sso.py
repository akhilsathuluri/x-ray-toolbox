...
max_consolidation_iterations = 40
ii_exploration = 0
...
- leanness
- slack settings
- moving into a usable class
- connecting the xray viz to opt
- extend to compensation space
- add a test for the SSO
- use for DSL4RAS
- implement logging for test results
