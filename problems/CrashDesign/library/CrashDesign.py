...
class CrashDesign:
    def __init__(self):
        ...
        self.problem_description = (
            "Example problem demonstrating the usage of the XRay tool"
        )
    ...
    def E_rem(self):
        self.var["E_rem"] = self.var["m"] / 2 * np.power(self.var["v_0"], 2) - (
            self.var["F_1"] * self.var["d_1c"] + self.var["F_2"] * self.var["d_2c"]
        )
